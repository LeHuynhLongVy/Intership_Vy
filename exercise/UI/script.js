$(document).ready(function() {
  ...
  btnPhoto.on({
    "click": function() {
      if (!btnPhoto.hasClass("chosen") && (document.title == "Feed Albums")){
        btnPhoto.addClass("chosen")
        btnAlbum.removeClass("chosen")
        window.location.href='FeedPhotos.html';
      }
      else if (!btnPhoto.hasClass("chosen") && (document.title == "Discovery Albums")) {
        btnPhoto.addClass("chosen")
        btnAlbum.removeClass("chosen")
        window.location.href='DiscoveryPhotos.html';
      }
    }
  })
  btnAlbum.on({
    "click": function() {
      if (!btnAlbum.hasClass("chosen") && (document.title == "Feed Photos")) {
        btnAlbum.addClass("chosen")
        btnPhoto.removeClass("chosen")
        window.location.href='FeedAlbums.html';
      }
      else if (!btnAlbum.hasClass("chosen") && (document.title == "Discovery Photos")) {
        btnAlbum.addClass("chosen")
        btnPhoto.removeClass("chosen")
        window.location.href='DiscoveryAlbums.html';
      }
    }
  })
